<?php $__env->startSection('head'); ?>
    <link data-minify="1" rel="preload stylesheet" as="style" id="pixel-services-css" href=<?php echo e(asset('web/wp-content/cache/min/1/wp-content/themes/pixelcrayons/v3.0/assets/css/software-engineering.css')); ?> media="all" />
    ...
    <section class="video-banner-section  text-left padding-t-120 padding-b-120">
        ...
        <div class="container">
            ...
            <div class="badges">
                <?php for($i=1;$i<=4;$i++): ?>
                <picture>
                    <img loading="lazy" src=<?php echo e("https://www.pixelcrayons.com/wp-content/themes/pixelcrayons/v3.0/assets/images/partner-0".$i.".svg"); ?> alt="Pixelcrayons" width="107" height="60" alt="tft0imol">
                </picture>
                <?php endfor; ?>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bitwords\resources\views/pages/services/software_engineering.blade.php ENDPATH**/ ?>